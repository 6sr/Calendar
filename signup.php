...
if(isset($_POST['Signup'])){
    ...
    if($username && $mail && $password) {
        ...
        $query = "select * from users where mail='$mail' AND username='$username'";
        ...
        if(mysqli_num_rows($runqueryCheck1)>0) {
            ...
            $query2="insert into users (username,mail,password) values('$username','$mail','$password')";
            $runquery2=mysqli_query($con,$query2);

            if($runquery2){
                $query1="select * from users where mail='$mail' AND username='$username'";
                ...
                if($img != "") {
                    ...
                    $filepath="userData/".$queryObj['id'].".".explode(".",$img)[1];
